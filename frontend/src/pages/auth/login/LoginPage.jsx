	...
	return (
		<div className='min-h-screen bg-gradient-to-b from-gray-800 to-gray-900 flex items-center justify-center px-4'>
			<div className='bg-gray-800 shadow-lg rounded-lg p-8 max-w-md w-full'>
				...
				<h1 className='text-2xl font-semibold text-center text-white mb-4'>Log In</h1>
				<form className='space-y-6' onSubmit={handleSubmit}>
					<div className='flex flex-col'>
						<label className='flex items-center gap-2 mb-2'>
							...
							<input
								type='text'
								className='bg-gray-700 border border-gray-600 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full text-white'
